...
public class RobotMap {
	...
	// Motors
	private static final int climbMotor1 = 2;
	private static final int climbMotor2 = 3;
	...
	// ---------------------------------------------------------------------------
	// IDs
	private final static int indexBackMotorID = 4;
	private final static int indexFrontMotorID = 5;
	private final static int indexMidMotorID = 6;
	...
	// Flywheel subsystem
	// ------------------------------------------------------------------------------
	public static final int flywheelLeftMotorID = 8;
	public static final int flywheelRightMotorID = 9;
	...
	public static final int INTAKE_FRONT_DOWN_PORT = 3;
	public static final int INTAKE_BACK_DOWN_PORT = 4;

	public static Solenoid frontIntakeliftSolenoid = new Solenoid(INTAKE_FRONT_DOWN_PORT);
	public static Solenoid backIntakeLiftSolenoid = new Solenoid(INTAKE_BACK_DOWN_PORT);

	public static final int INTAKE_FRONT_PORT = 10;
	public static final int INTAKE_BACK_PORT = 11;
	...
	public static final int LIFT_DOWN_PORT = 6;
	...
	public static final int CONTROL_PANEL_MOTOR_PORT = 12;
